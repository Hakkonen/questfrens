      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">QUESTFRENS</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">QuestFrens are a set of 4,096 algorithmically generated NFTs that utilise the <a href="https://stampchain.io/" target="_blank" style={{ color: "orange" }}>STAMP</a> protocol to permanently engrave the assets on to the Bitcoin chain, ensuring they exist as long as Bitcoin does. 
            <br></br>
            <br></br>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>i. Open Freewallet and select the "Send Funds" function</span>
                    </li>
                    <li>
                      <span>
                        ii. Select "Bitcoin" from the token name
                      </span>
                    </li>
                    <li className="flex items-center mb-2">
                      {/* <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
